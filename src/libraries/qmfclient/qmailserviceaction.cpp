...
{
    onlineCopyMessages(ids, destinationId);
}
...
{
    onlineMoveMessages(ids, destinationId);
}
...
/*!
    ...
    \sa createFolder(), renameFolder(), onlineCreateFolder(), onlineRenameFolder()
*/
void QMailStorageAction::deleteFolder(const QMailFolderId &folderId)
{
    onlineDeleteFolder(folderId);
}
